...
//        	System.out.println(values.size());
    ...
    private Value calcKmeans(ArrayList<Value> values2) {
    	System.out.println("Calc Kmeans");
    	for(int numClusters=1; numClusters<20; numClusters++){
			KmeansClustering obj=new KmeansClustering(values2, numClusters);
			obj.createRandomCentroids();
			obj.assignPoints();
			obj.iterate();
			KmeansClustering.calcSSE(obj.clusters, numClusters);
		}
		System.out.println(KmeansClustering.SSEvsNumClust.values());
		KmeansClustering.graph();
		return KmeansClustering.bestCluster;
	}
